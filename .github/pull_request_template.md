...
- [ ] I searched [open issues](https://github.com/BestMiraPro/Odysseus-expanded-AI-superapp/issues) and [open PRs](https://github.com/BestMiraPro/Odysseus-expanded-AI-superapp/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
